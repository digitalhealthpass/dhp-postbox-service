...
describe('test NoSql DB helper', () => {
    ...
    it('unhappy init unknown db', () => {
        ...
        try {
            ...
            expect(err.message).to.include('Unable to load NoSQL DB helper file unknown.js');
        }
    });
});
...
describe('test verifyDoc()', () => {
    ...
    it('unhappy verify doc', () => {
        ...
        try {
            ...
            expect(err.message).to.equal(`Document is missing id`);
...
describe('test handleError()', () => {
    it('happy handle error', () => {
        ...
        try {
            ...
            expect(err.message).to.deep.equal('Method: method; Doc ID: docId; Error: Not found');
